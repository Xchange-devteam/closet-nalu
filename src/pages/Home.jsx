  ...
  return (
    <div style={{ height: '100vh', overflow: 'hidden', position: 'relative', fontFamily: 'Georgia, serif', background: '#000' }}>
      ...
      <div className="cn-scroll">
        ...
        <section className="cn-abertura" style={{ background: '#AA1B2F', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', color: '#fff', overflow: 'hidden', position: 'relative', paddingBottom: 120 }}>
          <style>{`
        ...
        {pecas.map((p) => {
          ...
          return (
            <section className="cn-peca" key={p.id} style={{ position: 'relative', background: '#000' }}>
