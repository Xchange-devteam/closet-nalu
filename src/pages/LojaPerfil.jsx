...
const ICONES = {
  ...
  painel: (c) => <><rect x="3.5" y="4.5" width="17" height="15" rx="1.5" stroke={c} strokeWidth="1.6" fill="none" /><path d="M3.5 9h17M9 9v10.5" stroke={c} strokeWidth="1.6" fill="none" /></>,
  sair: (c) => <path d="M15 4h3a1 1 0 0 1 1 1v14a1 1 0 0 1-1 1h-3M10 8l-4 4 4 4M6 12h9" stroke={c} strokeWidth="1.6" fill="none" strokeLinecap="round" strokeLinejoin="round" />,
}
